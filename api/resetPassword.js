...
// ⚠️ NECESITAS INSTALAR 'bcryptjs' para hashear contraseñas
import { Pool } from 'pg';
...
// (Igual que en forgotPassword.js)
// ------------------------------------------------------------------
const pool = new Pool({
...
export default async (req, res) => {
    ...
    try {
        ...
        // Error 500 en caso de fallo de DB, hashing, o cualquier otro error inesperado
