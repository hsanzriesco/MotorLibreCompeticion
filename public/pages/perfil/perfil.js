document.addEventListener('DOMContentLoaded', () => {
    ...
    // Asumiendo que 'mostrarAlerta' es una función global disponible. 
    // Si no lo está, debe incluirse aquí o en un archivo auxiliar.
    /*
    function mostrarAlerta(msg, tipo) {
        // Implementación de mostrarAlerta (Toast, SweetAlert, etc.)
        console.log(`[ALERTA ${tipo.toUpperCase()}]: ${msg}`);
    }
    */
